...
const defaultData = [
  {
    ...
    text: "I have gone ahead and reset your password to the default. Please try logging in with 'ChangeMe123!' (without quotes). You will be prompted to create a new, secure password immediately upon signing in.",
  },
  {
    id: 1702,
    title: "Projector Fix",
    text: "It sounds like the display settings might be desynchronized. Please press the 'Windows' key + 'P' at the same time. Select 'Duplicate' from the menu on the right.",
  },
  {
    id: 1703,
    title: "Wifi Refresh",
    text: "Let's try a quick refresh. Please toggle your Wi-Fi 'Off,' count to five, and toggle it back 'On.' Ensure you are selecting the 'Staff-Secure' network.",
  },
];

// Load from LocalStorage OR use default
let responses =
  JSON.parse(localStorage.getItem("quickAssistData")) || defaultData;
  ...
  reader.onload = function (e) {
    try {
      ...
      if (!Array.isArray(importedData)) {
        alert(
          "This file doesn't look right. Are you sure it's a QuickAssist backup?"
        );
        return;
      }
